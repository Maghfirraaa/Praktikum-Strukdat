...
public class Graph {
    ...
    //No.1
    //Agar graph menjadi directed graph
    ...
    public void display(){
        ...
        for(int row=0; row<nVerts; row++){
            for(int col=0; col<nVerts;col++){ //col<row diganti col<nVerts
                if(adjMat[row][col]==1){
    ...
    //No.2
    //Connectivity pada directed graph
    public void dfs(){
    ...
    public int getAdjUnvisitedVertex(int v){
     ...
     //No.3
     //Topological Sorting dengan direct graph
     //Mempresentasikan topological sort
     public void topo(){
